      ...
      .then(result => {
        if(result.success) {
          ...
          mockCustomers = (result.data.customers || []).map(c => {
            return { id: c['\u9867\u5BA2ID'] || Object.values(c)[0] || '', name: c['\u304A\u5BA2\u69D8\u540D'] || Object.values(c)[1] || '', kana: c['\u3075\u308A\u304C\u306A'] || Object.values(c)[2] || '', address: c['\u4F4F\u6240\uFF08\u5E02\u753A\u6751\uFF09'] || Object.values(c)[3] || '', occupation: c['\u8077\u696D'] || Object.values(c)[4] || '', phone: c['\u96FB\u8A71\u756A\u53F7'] || Object.values(c)[5] || '', email: c['\u30E1\u30FC\u30EB\u30A2\u30C9\u30EC\u30B9'] || Object.values(c)[6] || '', firstVisit: c['\u521D\u56DE\u4E88\u7D04\u65E5'] || Object.values(c)[7] || '', lastVisit: c['\u6700\u7D42\u6765\u5E97\u65E5'] || Object.values(c)[8] || '', memo: c['\u30E1\u30E2'] || Object.values(c)[10] || '' }; }).filter(c => c.name && c.name.trim() !== '' && c.name !== '休み' && c.name !== 'x');
